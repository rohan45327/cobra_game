var Snake = (function () {
  ...
  var game = {
    ...
    reset: function () {
      ctx.fillStyle = alert("LOADING...\nPress OK if you are ready to play")
    ...
    loop: function () {
      ...
      for(var i=0; i<trail.length-1; i++) {
        ctx.fillRect(trail[i].x * gridSize+5, trail[i].y * gridSize+5, gridSize-10, gridSize-10);
...
//fruit color ra fruituu
      ctx.fillStyle = 'yellow';
      ctx.fillRect(fruit.x * gridSize+1, fruit.y * gridSize+1, gridSize-2, gridSize-2);

      if(stopped) {
        ctx.fillStyle = 'rgba(20,250,260,0.8)';
